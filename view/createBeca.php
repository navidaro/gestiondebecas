            ...
            <form class="col s12" action="../controller/controllerBeca.php">
                ...
                <div class='row'>
                    ...
                    <div class='input-field col s6'>
                        ...
                        <input class='validate' type='number' name='monto' id='cedula' minlength="0"  maxlength="10"/>
                ...
                <div class='row'>
                    <div class='input-field col s6'>
                        ...
                        <input class='validate' type='number' name='promedio' id='cedula' minlength="0"  maxlength="10"/>
